...
namespace GUIEmployee.ReservationSrv {
    ...
    public interface IReservationService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IReservationService/updateReservation", ReplyAction="http://tempuri.org/IReservationService/updateReservationResponse")]
        System.Threading.Tasks.Task<int> updateReservationAsync(string firstName, string lastName, int sessionId, int numberOfSeats, double price, string status, int reservationId, string data);
    ...
    public partial class ReservationServiceClient : System.ServiceModel.ClientBase<GUIEmployee.ReservationSrv.IReservationService>, GUIEmployee.ReservationSrv.IReservationService {
        ...
        public System.Threading.Tasks.Task<int> updateReservationAsync(string firstName, string lastName, int sessionId, int numberOfSeats, double price, string status, int reservationId, string data) {
