...
namespace GUIEmployee.CustomerSrv {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CustomerSrv.ICustomerService")]
    public interface ICustomerService {
        ...
        GUIEmployee.CustomerSrv.Customer getCustomerByName(string fName, string lName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerService/getCustomerByName", ReplyAction="http://tempuri.org/ICustomerService/getCustomerByNameResponse")]
        System.Threading.Tasks.Task<GUIEmployee.CustomerSrv.Customer> getCustomerByNameAsync(string fName, string lName);
        ...
        GUIEmployee.CustomerSrv.Customer getCustomerByUsername(string username);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerService/getCustomerByUsername", ReplyAction="http://tempuri.org/ICustomerService/getCustomerByUsernameResponse")]
        System.Threading.Tasks.Task<GUIEmployee.CustomerSrv.Customer> getCustomerByUsernameAsync(string username);
        ...
        GUIEmployee.CustomerSrv.Customer[] getCustomers();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerService/getCustomers", ReplyAction="http://tempuri.org/ICustomerService/getCustomersResponse")]
        System.Threading.Tasks.Task<GUIEmployee.CustomerSrv.Customer[]> getCustomersAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICustomerServiceChannel : GUIEmployee.CustomerSrv.ICustomerService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CustomerServiceClient : System.ServiceModel.ClientBase<GUIEmployee.CustomerSrv.ICustomerService>, GUIEmployee.CustomerSrv.ICustomerService {
        ...
        public GUIEmployee.CustomerSrv.Customer getCustomerByName(string fName, string lName) {
            return base.Channel.getCustomerByName(fName, lName);
        }
        
        public System.Threading.Tasks.Task<GUIEmployee.CustomerSrv.Customer> getCustomerByNameAsync(string fName, string lName) {
            return base.Channel.getCustomerByNameAsync(fName, lName);
        }
        
        public GUIEmployee.CustomerSrv.Customer getCustomerByUsername(string username) {
            return base.Channel.getCustomerByUsername(username);
        }
        
        public System.Threading.Tasks.Task<GUIEmployee.CustomerSrv.Customer> getCustomerByUsernameAsync(string username) {
            return base.Channel.getCustomerByUsernameAsync(username);
        }
        
        public GUIEmployee.CustomerSrv.Customer[] getCustomers() {
            return base.Channel.getCustomers();
        }
        
        public System.Threading.Tasks.Task<GUIEmployee.CustomerSrv.Customer[]> getCustomersAsync() {
