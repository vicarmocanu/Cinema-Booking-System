...
namespace ConsoleTesting.SeatServiceReference {
    ...
    public partial class Seat : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private ConsoleTesting.SeatServiceReference.Room RoomField;
        ...
        public ConsoleTesting.SeatServiceReference.Room Room {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SeatServiceReference.ISeatService")]
    public interface ISeatService {
        ...
        ConsoleTesting.SeatServiceReference.Seat getSeat(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISeatService/getSeat", ReplyAction="http://tempuri.org/ISeatService/getSeatResponse")]
        System.Threading.Tasks.Task<ConsoleTesting.SeatServiceReference.Seat> getSeatAsync(int id);
        ...
        ConsoleTesting.SeatServiceReference.Seat[] getSeats();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISeatService/getSeats", ReplyAction="http://tempuri.org/ISeatService/getSeatsResponse")]
        System.Threading.Tasks.Task<ConsoleTesting.SeatServiceReference.Seat[]> getSeatsAsync();
        ...
        ConsoleTesting.SeatServiceReference.Seat[] getRoomSeats(int roomNumber);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISeatService/getRoomSeats", ReplyAction="http://tempuri.org/ISeatService/getRoomSeatsResponse")]
        System.Threading.Tasks.Task<ConsoleTesting.SeatServiceReference.Seat[]> getRoomSeatsAsync(int roomNumber);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISeatServiceChannel : ConsoleTesting.SeatServiceReference.ISeatService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SeatServiceClient : System.ServiceModel.ClientBase<ConsoleTesting.SeatServiceReference.ISeatService>, ConsoleTesting.SeatServiceReference.ISeatService {
        ...
        public ConsoleTesting.SeatServiceReference.Seat getSeat(int id) {
            return base.Channel.getSeat(id);
        }
        
        public System.Threading.Tasks.Task<ConsoleTesting.SeatServiceReference.Seat> getSeatAsync(int id) {
            return base.Channel.getSeatAsync(id);
        }
        
        public ConsoleTesting.SeatServiceReference.Seat[] getSeats() {
            return base.Channel.getSeats();
        }
        
        public System.Threading.Tasks.Task<ConsoleTesting.SeatServiceReference.Seat[]> getSeatsAsync() {
            return base.Channel.getSeatsAsync();
        }
        
        public ConsoleTesting.SeatServiceReference.Seat[] getRoomSeats(int roomNumber) {
            return base.Channel.getRoomSeats(roomNumber);
        }
        
        public System.Threading.Tasks.Task<ConsoleTesting.SeatServiceReference.Seat[]> getRoomSeatsAsync(int roomNumber) {
