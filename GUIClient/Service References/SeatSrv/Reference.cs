...
namespace GUIClient.SeatSrv {
    ...
    public partial class Seat : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private GUIClient.SeatSrv.Room RoomField;
        ...
        public GUIClient.SeatSrv.Room Room {
            get {
    ...
    public interface ISeatService {
        ...
        GUIClient.SeatSrv.Seat getSeat(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISeatService/getSeat", ReplyAction="http://tempuri.org/ISeatService/getSeatResponse")]
        System.Threading.Tasks.Task<GUIClient.SeatSrv.Seat> getSeatAsync(int id);
        ...
        GUIClient.SeatSrv.Seat[] getSeats();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISeatService/getSeats", ReplyAction="http://tempuri.org/ISeatService/getSeatsResponse")]
        System.Threading.Tasks.Task<GUIClient.SeatSrv.Seat[]> getSeatsAsync();
        ...
        GUIClient.SeatSrv.Seat[] getRoomSeats(int roomNumber);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISeatService/getRoomSeats", ReplyAction="http://tempuri.org/ISeatService/getRoomSeatsResponse")]
        System.Threading.Tasks.Task<GUIClient.SeatSrv.Seat[]> getRoomSeatsAsync(int roomNumber);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISeatServiceChannel : GUIClient.SeatSrv.ISeatService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SeatServiceClient : System.ServiceModel.ClientBase<GUIClient.SeatSrv.ISeatService>, GUIClient.SeatSrv.ISeatService {
        ...
        public GUIClient.SeatSrv.Seat getSeat(int id) {
            return base.Channel.getSeat(id);
        }
        
        public System.Threading.Tasks.Task<GUIClient.SeatSrv.Seat> getSeatAsync(int id) {
            return base.Channel.getSeatAsync(id);
        }
        
        public GUIClient.SeatSrv.Seat[] getSeats() {
            return base.Channel.getSeats();
        }
        
        public System.Threading.Tasks.Task<GUIClient.SeatSrv.Seat[]> getSeatsAsync() {
            return base.Channel.getSeatsAsync();
        }
        
        public GUIClient.SeatSrv.Seat[] getRoomSeats(int roomNumber) {
            return base.Channel.getRoomSeats(roomNumber);
        }
        
        public System.Threading.Tasks.Task<GUIClient.SeatSrv.Seat[]> getRoomSeatsAsync(int roomNumber) {
